    ...
    return Column(
      children: [
        Container(
          ...
          child: Padding(
            padding: const EdgeInsets.only(top: 50, right: 20, left: 215, bottom: 15),
            child: Column(
              children: [
                Row(
  ...
  Widget makeStatCrad(String cardType, MaterialColor color, IconData icon) {
    return Padding(
      ...
      child: Card(
        elevation: 5.0,
        child: Container(
          decoration: BoxDecoration(color: Colors.white54, borderRadius: BorderRadius.circular(10), boxShadow: [
            BoxShadow(
              color: grey.withOpacity(0.01),
              spreadRadius: 10,
              blurRadius: 3,
